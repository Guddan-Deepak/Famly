...
// Import icons for the sidebar
import { Home, Users, PlusCircle, Clock, TreePalm, Search, BookText, Link, Download, Bell, Menu, X } from "lucide-react";
...
export default function DashboardLayout() {
    ...
    useEffect(() => {
        // auth is null initially, then gets set from localStorage
        // We only want to redirect if auth is definitely not null and user doesn't exist
        if (auth !== null) {
